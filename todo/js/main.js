...
var createItemDom = function(text, status) {
    ...
    listItem.className = (status == 'un-check') ? 'Checked well' : 'uncompleted well';

    itemLabel.innerText = text;
    itemCompBtn.className = 'btn btn-success';
    itemCompBtn.innerText = (status == 'un-check') ? 'Check' : 'un-check';
    if (status == 'un-check') {
...
var addToList = function() {
    ...
    refreshLocal();
    //change the dom
    var item = createItemDom(addInput.value, 'un-check');
